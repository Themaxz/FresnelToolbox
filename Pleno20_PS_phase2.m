function [F3,image,lens_image]=Pleno20_PS_phase2(P,L,M,za,zb,z2,a,b,lambda,phase)
...
% fclose(fid);
    ...
    mask=Makepupil(w,3499,.5e-4);
    mask.field=1-mask.field;
    F2_.field=F2_.field.*mask.field;
