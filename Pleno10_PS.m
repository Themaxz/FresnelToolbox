function [F3,image]=Pleno10_PS(P,L,M,z1,z2,a,lambda,aberration)
...
F3.aberration=aberration;
file=[a,F3.fnumberm,F3.cutoffm,z2,F3.fnumberL,F3.cutoffL] ;
%log file generator
% freq=num2str(frequency);
date=datestr(clock,29);
cell=['a              ';'Fmicro         ';'Cutoff micro   ';'z              ';'Flens          ';'cutoff lens    '];
fid=fopen(strcat(date,aberration,'.txt'),'w');
